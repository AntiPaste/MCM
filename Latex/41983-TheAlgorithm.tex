...
First we run a SEIAR algorithm in-city, which is illustrated in the following section in detail. Then a similar procedure is run on an inter-city level, with different parameters, and finally on an inter-regional level.
