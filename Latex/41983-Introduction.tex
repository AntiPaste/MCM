...
While there was plentiful research on spread of different diseases, and several mathematical models for various different types of behaviour in endemics, we found little research on efficient medicine delivery mechanisms. Out of several prevalent models, the closest to our scenario is the SEIR model. This model considers four states: Susceptible, Exposed, Infected, and Removed. The susceptible population has not yet contracted the disease, the exposed have contracted the the virus, but the disease has not yet set in and do not spread the disease, the infected are showing symptoms and spread the disease, and finally the removed are either immune or dead. This model describes the states of Ebola quite well, but we added a new state, Advanced, to distinguish those we can medicate, and those we can not, for the cure will not work when the victims condition becomes advanced.
